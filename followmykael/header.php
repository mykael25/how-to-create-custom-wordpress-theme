...
<head>
    ...
    <!-- commented this to make titles dynamic -->
    <!-- Meta -->
    <meta charset="utf-8">
    ...
    <link rel="shortcut icon" href="wp-content\themes\followmykael\assets\images\logo.png"> 
	...
	<!-- Theme CSS -->
	<!-- <link rel="stylesheet" href="wp-content/themes/followmykael/style.css"> -->
    <?php
wp_head();
?>
